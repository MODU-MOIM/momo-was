...
@Builder
public record CrewReviewListResDto(
        Long reviewId,
        String writer,
        String profileImage,
    ...
    public static CrewReviewListResDto of(CrewReview crewReview, List<Keyword> keywords, ScheduleInfoResDto scheduleInfoResDto) {
        return CrewReviewListResDto.builder()
