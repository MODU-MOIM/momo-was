...
public class JoinRequestController {
    ...
    @PreAuthorize("isAuthenticated() and @crewManager.hasCrewLeaderPermission(#crewId, #userId)") //Leader 권한만 호출 가능하도록
    public Map<String, Object> acceptJoinRequest(@PathVariable Long crewId,
    ...
    @PreAuthorize("isAuthenticated() and @crewManager.hasCrewLeaderPermission(#crewId, #userId)") //Leader 권한만 호출 가능하도록
    public CommonResponse<String> rejectJoinRequest(@PathVariable Long crewId,
                                                    @PathVariable Long joinRequestId,
                                                    @AuthenticationPrincipal Long userId) {
